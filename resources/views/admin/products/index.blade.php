...
<div class="btn-toolbar mb-2 mb-md-0">
  ...
  <a class="btn btn-secondary" href="{{route('admin.product.create')}}">Add New</a>
</div>
</div>
<div class="table-responsive">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$product->title}}</td>
      <td><img src="{{asset($product->photo)}}" width="120px" /></td>
      <td>{{$product->price}}</td>
      ...
      <td>
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="{{route('admin.product.show', $product->id)}}">Preview</a></li>
